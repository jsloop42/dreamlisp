...
- (void)addArithmeticFunctions {
    ...
    [add setArgsCount:-1];
    [_env setObject:add forKey:[[DLSymbol alloc] initWithFunction:add name:@"+" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:subtract forKey:[[DLSymbol alloc] initWithFunction:subtract name:@"-" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:multiply forKey:[[DLSymbol alloc] initWithFunction:multiply name:@"*" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:divide forKey:[[DLSymbol alloc] initWithFunction:divide name:@"/" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"mod" moduleName:[Const coreModuleName]]];
}
...
- (void)addComparisonFunctions {
    ...
    [_env setObject:lessThan forKey:[[DLSymbol alloc] initWithFunction:lessThan name:@"<" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:greaterThan forKey:[[DLSymbol alloc] initWithFunction:greaterThan name:@">" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:lessThanOrEqualTo forKey:[[DLSymbol alloc] initWithFunction:lessThanOrEqualTo name:@"<=" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:greaterThanOrEqualTo forKey:[[DLSymbol alloc] initWithFunction:greaterThanOrEqualTo name:@">=" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:equalTo forKey:[[DLSymbol alloc] initWithFunction:equalTo name:@"=" moduleName:[Const coreModuleName]]];
}
...
- (void)addPrintFunctions {
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"println" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"prn" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"print" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"pr-str" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"str" moduleName:[Const coreModuleName]]];
}
...
- (void)addListFunctions {
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"list" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"empty?" moduleName:[Const coreModuleName]]];
    ...
    id<DLDataProtocol>(^count)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            if ([DLString isString:first]) {
                ...
                [[[DLError alloc] initWithFormat:DataTypeMismatchWithNameArity, @"count/1", @"'sequence' or 'collection'", 1,
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"count" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"cons" moduleName:[Const coreModuleName]]];
            ...
            if ([DLList isKindOfList:first]) {
                ...
                for (i = 1; i < len; i++) {
                    ...
                    if ([DLList isKindOfList:elem]) {
                        ...
                        [[[DLError alloc] initWithFormat:DataTypeMismatchWithNameArity, @"concat/n", @"'sequence'", i + 1, [elem dataTypeName]] throw];
                    }
                }
                ...
                for (i = 1; i < len; i++) {
                    elem = [xs nth:i];
                    if ([DLList isKindOfList:elem]) {
                        [Utils appendStringFromArray:[(DLList *)elem value] string:str];
                    } else if ([DLString isString:elem]) {
                        [str append:elem];
                    } else {
    //                    [str appendString:[elem description]];
                ...
                [[[DLError alloc] initWithFormat:DataTypeMismatchWithNameArity, @"concat/n", @"'sequence'", 1, [first dataTypeName]] throw];
            }
            return [DLList new];
        }
    };
    fn = [[DLFunction alloc] initWithFn:concat argCount:-1 name:@"concat/n"];
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"concat" moduleName:[Const coreModuleName]]];
    ...
    id<DLDataProtocol>(^nthTail)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            [[[DLError alloc] initWithFormat:DataTypeMismatchWithArity, fnName, @"'sequence'", len, [data dataTypeName]] throw];
            return [DLNil new];
        }
    };
    fn = [[DLFunction alloc] initWithFn:nthTail argCount:3 name:@"nth-tail/3"];
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"nth-tail" moduleName:[Const coreModuleName]]];
    ...
    id<DLDataProtocol>(^first)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            if ([DLList isKindOfList:elem]) {
                ...
                [[[DLError alloc] initWithFormat:DataTypeMismatchWithNameArity, @"first/1", @"'sequence'", 1, [elem dataTypeName]] throw];
            }
            return first ? first : [DLNil new];
        }
    };
    fn = [[DLFunction alloc] initWithFn:first argCount:1 name:@"first/1"];
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"first" moduleName:[Const coreModuleName]]];
    ...
    id<DLDataProtocol>(^rest)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            if ([DLList isKindOfList:data]) {
                ...
                NSMutableArray *arr = [Utils stringToArray:(DLString *)data isNative:YES];
            ...
            [[[DLError alloc] initWithFormat:DataTypeMismatchWithName, @"rest/1", @"'sequence'", [data dataTypeName]] throw];
            return [DLList new];
        }
    };
    fn = [[DLFunction alloc] initWithFn:rest argCount:1 name:@"rest/1"];
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"rest" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"map" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"conj" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"seq?" moduleName:[Const coreModuleName]]];
    ...
    id<DLDataProtocol>(^seq)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            [[[DLError alloc] initWithDescription:SequenceError] throw];
            return nil;
        }
    };
    ...
    id<DLDataProtocol>(^last)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            if ([DLList isKindOfList:seq]) {
                ...
                [[[DLError alloc] initWithFormat:DataTypeMismatchWithNameArity, @"last/1", @"'sequence'", 1, [list dataTypeName]] throw];
            }
            return last == nil ? [DLNil new] : last;
        }
    };
    fn = [[DLFunction alloc] initWithFn:last argCount:1 name:@"last/1"];
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"last" moduleName:[Const coreModuleName]]];
    ...
    id<DLDataProtocol>(^drop)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            [[[DLError alloc] initWithFormat:DataTypeMismatchWithNameArity, @"drop/2", @"'sequence'", 2, [second dataTypeName]] throw];
            return nil;
        }
    };
    fn = [[DLFunction alloc] initWithFn:drop argCount:2 name:@"drop/2"];
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"drop" moduleName:[Const coreModuleName]]];
    ...
    id<DLDataProtocol>(^lazyReverse)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            if ([DLList isKindOfList:first]) {
                ...
                [[[DLError alloc] initWithFormat:DataTypeMismatchWithNameArity, @"reverse/1", @"'sequence'", 1, [first dataTypeName]] throw];
            }
            [seq updateEnumerator];
            return seq;
        }
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"reverse" moduleName:[Const coreModuleName]]];
    ...
    id<DLDataProtocol>(^sort)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            [[[DLError alloc] initWithFormat:DataTypeMismatchWithNameArity, @"sort/2", @"'sequence' or 'collection'", 2, [second dataTypeName]] throw];
            return nil;
        }
    };
    fn = [[DLFunction alloc] initWithFn:sort argCount:2 name:@"sort/2"];
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"sort" moduleName:[Const coreModuleName]]];
    ...
    id<DLDataProtocol>(^lazyFilter)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            if ([DLList isList:second]) {
                ...
                [[[DLError alloc] initWithFormat:DataTypeMismatchWithNameArity, @"filter/2", @"'collection'", 2, [first dataTypeName]] throw];
            }
            return seq;
        }
    };
    fn = [[DLFunction alloc] initWithFn:lazyFilter argCount:2 name:@"filter/2"];
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"filter" moduleName:[Const coreModuleName]]];
    ...
    id<DLDataProtocol>(^parition)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            [[[DLError alloc] initWithFormat:DataTypeMismatchWithNameArity, @"partition/2", @"'collection'", 2, [first dataTypeName]] throw];
            return nil;
        }
    };
    fn = [[DLFunction alloc] initWithFn:parition argCount:2 name:@"partition/2"];
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"partition" moduleName:[Const coreModuleName]]];
    ...
    id<DLDataProtocol>(^lazyFlatten)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            if ([DLLazySequence isLazySequence:first]) {
                ...
                [[[DLError alloc] initWithFormat:DataTypeMismatchWithName, @"flatten/1", @"'collection'", [first dataTypeName]] throw];
            }
            return seq;
        }
    };
    fn = [[DLFunction alloc] initWithFn:lazyFlatten argCount:1 name:@"flatten/1"];
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"flatten" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"take" moduleName:[Const coreModuleName]]];
    ...
    id<DLDataProtocol>(^join)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            NSString *sep = nil;
            BOOL isString = NO;
            if ([DLHashMap isHashMap:first]) first = [[DLVector alloc] initWithArray:[Utils toArray:first isNative:YES]];
            NSMutableArray *list =  [Utils toArray:second isNative:![DLString isString:second]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"join" moduleName:[Const coreModuleName]]];
        ...
        @autoreleasepool {
            ...
            if ([DLList isList:first]) {
                ...
                if ([DLList isKindOfList:second]) {
                    ...
                    [[[DLError alloc] initWithFormat:DataTypeMismatchWithName, @"into/2", @"'sequence' or 'collection'", [second dataTypeName]] throw];
                    return [DLNil new];
                }
            } else if ([DLVector isVector:first]) {
                DLVector *vec = (DLVector *)first;
                ...
                if ([DLList isKindOfList:second]) {
                    ...
                    [[[DLError alloc] initWithFormat:DataTypeMismatchWithName, @"into/2", @"'collection'", [second dataTypeName]] throw];
                    return [DLNil new];
                }
            } else {
                [[[DLError alloc] initWithFormat:DataTypeMismatchWithNameArity, @"into/2", @"'collection'", 1, [first dataTypeName]] throw];
                return [DLNil new];
            }
            return ret;
        }
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"into" moduleName:[Const coreModuleName]]];
    ...
    id<DLDataProtocol>(^indexOf)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            if ([DLList isKindOfList:second]) {
                ...
                [[[DLError alloc] initWithFormat:DataTypeMismatchWithNameArity, @"index-of/2", @"'sequence'", 2, [second dataTypeName]] throw];
            }
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"index-of" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"foldl" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"foldr" moduleName:[Const coreModuleName]]];
    ...
    id<DLDataProtocol>(^append)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            if (index < 0) [[[DLError alloc] initWithFormat:IndexOutOfBounds, index, 0] throw];
            if ([DLString isString:data]) {
                ...
                if (index > len) [[[DLError alloc] initWithFormat:IndexOutOfBounds, index, len] throw];
            ...
            [[[DLError alloc] initWithFormat:DataTypeMismatchWithNameArity, fnName, @"'sequence'", 3, [data dataTypeName]] throw];
            return [DLNil new];
        }
    };
    fn = [[DLFunction alloc] initWithFn:append argCount:3 name:@"append/3"];
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"append" moduleName:[Const coreModuleName]]];
}
...
- (void)addVectorFunctions {
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"vector" moduleName:[Const coreModuleName]]];
...
- (void)addHashMapFunctions {
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"hash-map" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"assoc" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"dissoc" moduleName:[Const coreModuleName]]];
    ...
    id<DLDataProtocol>(^get)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            if ([DLHashMap isHashMap:coll]) {
                ...
                [[[DLError alloc] initWithFormat:DataTypeMismatchWithName, @"get/2",  @"'hash-map'", [coll dataTypeName]] throw];
            }
            return val ? val : [DLNil new];
        }
    };
    fn = [[DLFunction alloc] initWithFn:get argCount:2 name:@"get/2"];
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"get" moduleName:[Const coreModuleName]]];
    ...
    id<DLDataProtocol>(^contains)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            if ([DLHashMap isHashMap:data]) {
                ...
                [[[DLError alloc] initWithFormat:DataTypeMismatchWithNameArity, fnName, @"'sequence' or 'collection'", 2, [data dataTypeName]] throw];
            }
            return [[DLBool alloc] initWithBool:isExists];
        }
    };
    fn = [[DLFunction alloc] initWithFn:contains argCount:2 name:@"contains?/2"];
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"contains?" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"keys" moduleName:[Const coreModuleName]]];
...
- (void)addAtomFunctions {
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"atom" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"deref" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"reset!" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"swap!" moduleName:[Const coreModuleName]]];
}
...
- (void)addInvokeFunctions {
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"throw" moduleName:[Const coreModuleName]]];
    ...
    id<DLDataProtocol>(^apply)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            if (fnArgsCount != -1 && fnArgsCount != paramsCount) [[[DLError alloc] initWithFormat:ArityError, fnArgsCount, paramsCount] throw];
            return [fn apply:arr];
        }
    };
    fn = [[DLFunction alloc] initWithFn:apply argCount:-1 name:@"apply/n"];
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"apply" moduleName:[Const coreModuleName]]];
}
...
- (void)addSymbolFunctions {
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"symbol" moduleName:[Const coreModuleName]]];
...
- (void)addKeywordFunctions {
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"keyword" moduleName:[Const coreModuleName]]];
...
- (void)addLazyFunctions {
    ...
    id<DLDataProtocol>(^lazySeq)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            id<DLDataProtocol> first = [xs first];
            if ([DLString isString:first]) {
                return [[DLLazySequence alloc] initWithArray:[Utils toArray:first isNative:YES] sequenceType:SequenceTypeString];
            } else if ([DLList isKindOfList:first]) {
            ...
            [[[DLError alloc] initWithFormat:DataTypeMismatchWithName, @"lazy-seq/1", @"sequence", [first dataTypeName]] throw];
            return [DLNil new];
        }
    };
    fn = [[DLFunction alloc] initWithFn:lazySeq argCount:1 name:@"lazy-seq/1"];
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"lazy-seq" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"has-next?" moduleName:[Const coreModuleName]]];
    ...
    id<DLDataProtocol>(^next)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            if (![seq hasNext]) [[[DLError alloc] initWithFormat:IndexOutOfBounds, [seq index], [seq length]] throw];
            return [seq next];
        }
    };
    fn = [[DLFunction alloc] initWithFn:next argCount:1 name:@"next/1"];
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"next" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"dorun" moduleName:[Const coreModuleName]]];
...
- (void)addPredicateFunctions {
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"nil?" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"true?" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"false?" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"string?" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"number?" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"fn?" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"macro?" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"zero?" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"coll?" moduleName:[Const coreModuleName]]];
    ...
    id<DLDataProtocol>(^evenp)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            if ([num isDouble]) [[[DLError alloc] initWithFormat:DataTypeMismatchWithName, fnName, @"'integer'", @"double"] throw];
            return [[DLBool alloc] initWithBool:[num integerValue] % 2 == 0];
        }
    };
    fn = [[DLFunction alloc] initWithFn:evenp argCount:1 name:@"even?/1"];
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"even?" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"odd?" moduleName:[Const coreModuleName]]];
}
...
- (void)addEvalFunctions {
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"read-string" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"slurp" moduleName:[Const coreModuleName]]];
    ...
    id<DLDataProtocol>(^gensym)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            ...
            return [[DLSymbol alloc] initWithName:[NSString stringWithFormat:@"%@__%ld", name, [State counter]]];
        }
    };
    fn = [[DLFunction alloc] initWithFn:gensym argCount:-1 name:@"gensym/n"];
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"gensym" moduleName:[Const coreModuleName]]];
}
...
- (void)addMetaFunctions {
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"with-meta" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"meta" moduleName:[Const coreModuleName]]];
}
...
- (void)addMiscFunctions {
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"exit*" moduleName:[Const coreModuleName]]];
    ...
    id<DLDataProtocol>(^timems)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            [TypeUtils checkArity:xs arity:0];
            return [[DLNumber alloc] initWithInteger:[Utils timestamp]];
        }
    };
    fn = [[DLFunction alloc] initWithFn:timems argCount:0 name:@"time-ms/0"];
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"time-ms" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"type" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"info" moduleName:[Const coreModuleName]]];
}
...
- (NSMapTable * _Nullable)moduleInfo:(NSString *)moduleName {
    @autoreleasepool {
        ...
        [info setObject:[[DLVector alloc] initWithArray:[exportedFns mutableCopy]] forKey:[[DLKeyword alloc] initWithString:[Const exports]]];
        [info setObject:[[DLVector alloc] initWithArray:[importedFns mutableCopy]] forKey:[[DLKeyword alloc] initWithString:[Const imports]]];
        [info setObject:[[DLVector alloc] initWithArray:[internalFns mutableCopy]] forKey:[[DLKeyword alloc] initWithString:[Const internal]]];
        [info setObject:[[DLString alloc] initWithString:moduleName] forKey:[[DLKeyword alloc] initWithString:[Const name]]];
        [info setObject:[[DLString alloc] initWithString:[env moduleDescription]] forKey:[[DLKeyword alloc] initWithString:[Const description]]];
        return info;
    }
}
...
- (void)addModuleFunctions {
    ...
    id<DLDataProtocol>(^currentModuleName)(NSMutableArray *xs) = ^id<DLDataProtocol>(NSMutableArray *xs) {
        @autoreleasepool {
            return [[DLString alloc] initWithString:[State currentModuleName]];
        }
    };
    fn = [[DLFunction alloc] initWithFn:currentModuleName argCount:0 name:@"current-module-name/0"];
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"current-module-name" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"module-info" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"module-exist?" moduleName:[Const coreModuleName]]];
    ...
    [_env setObject:fn forKey:[[DLSymbol alloc] initWithFunction:fn name:@"all-modules" moduleName:[Const coreModuleName]]];
}
